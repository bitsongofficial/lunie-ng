<template>
  <q-page class="column items-center">
    ...
    <h6 class="warning center-login-inner text-half-transparent-white text-center">Use this software at your own risk. never enter your seed phrase into untrusted software. Beware of phishing scams and spoof sites. Have a nice day</h6>
  </q-page>
</template>
